...
| 5 | Dogfood, enrollment, signed card, environment, and baseline records. | **Corrected repository-owned candidate implemented by US-110; not accepted.** Exact dogfood argv, independently trusted SSH Ed25519 authentication, bundle-resolved revisions, complete packet custody/digests, strict timeline, evidence binding, and adversarial negatives exist. Two real distinct owner/repository packets remain absent. |
