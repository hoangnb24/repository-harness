...
| [gap-analysis.md](gap-analysis.md) | BA technique. 4-step As-Is vs To-Be comparison: define future state → assess current state → identify gaps (6 categories: functional, process, technology, data, role/skill, compliance) → propose solutions with MoSCoW priority. Output directly feeds SOW § 4 in-scope decisions. Stage 3.B of solo-dev-client-delivery. |
