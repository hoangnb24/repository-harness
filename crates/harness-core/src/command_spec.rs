...
pub const CORE_COMMAND_SPEC_JSON: &str = r#"{"binary":["scripts/bin/harness","scripts/bin/harness.exe"],"top_level":["install","update","audit","scaffold","status","version"],"version_alias":"--version","commands":[{"name":"install","mutation":"managed-files-and-manifest","options":["--preview","--non-interactive","--accept-preview-sha256","--resume","--rollback"],"exits":[0,2,3,4,64,70,74]},{"name":"update","mutation":"managed-files-and-manifest","options":["--preview","--non-interactive","--accept-preview-sha256","--resume","--rollback"],"exits":[0,2,3,4,64,70,74]},{"name":"audit","mutation":"none","options":["--json"],"exits":[0,2,3,64,70,74]},{"name":"scaffold","mutation":"one-explicit-neutral-artifact","options":["--template","--destination","--preview","--non-interactive","--accept-preview-sha256","--resume","--rollback"],"exits":[0,3,4,64,70,74]},{"name":"status","mutation":"none","options":["--json"],"exits":[0,3,64,70,74]},{"name":"version","mutation":"none","options":["--json"],"exits":[0,64,70]}],"forbidden_top_level":["migrate","inspect","export","preview","apply","resume","rollback","init","intake","story","query","db"]}"#;
